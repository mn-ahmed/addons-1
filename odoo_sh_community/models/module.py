...
class Module(models.Model):
    ...
    def upgrade_changed_checksum(self, repo=False, overwrite_existing_translations=True):
        ...
        output_list.append("Marking the following modules to upgrade,for their checksums changed"+",".join(changed_modules.mapped("name")))
        ...
        if partial_modules:
            output_list.append("Checksum upgrade successful but incomplete for the following modules:"+  ",".join(partial_modules.mapped("name")))
            self.env.cr.commit()
